...
namespace University_Course_Registration_System
{
    ...
    public class Student
    {
        ...
        public int GetTotalCredits()
        {
            ...
            int sum=0;
            foreach(var it in RegisteredCourses) sum+=it.Credits;
            return sum;
        ...
        public bool CanAddCourse(Course course)
        {
            ...
            if (!(totalcredit + course.Credits <= MaxCredits)) return false;
            if (!course.HasPrerequisites(CompletedCourses)) return false;
            bool res1 = (from it in RegisteredCourses
                         where it.CourseCode == course.CourseCode
                         select it).Any();
        ...
        public bool AddCourse(Course course)
        {
            ...
            if(!CanAddCourse(course)||course.IsFull()) return false;
        ...
        public bool DropCourse(string courseCode)
        {
            ...
            Course res=(from it in RegisteredCourses
            where it.CourseCode==courseCode
            select it).First();
            if(res==null) return false;
            RegisteredCourses.Remove(res);
            res.DropStudent();
            return true;
            throw new NotImplementedException();
        }
        ...
        public void DisplaySchedule()
        {
            ...
            if(RegisteredCourses.Count==0) Console.WriteLine("No course registered");
            foreach(var it in RegisteredCourses)
            {
                Console.WriteLine(it.CourseCode+" "+it.CourseName+" "+it.Credits);
            }
            throw new NotImplementedException();
        }
    }
