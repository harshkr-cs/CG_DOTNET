...
class Program{
    ...
    //     }
       ...
       //stack->LIFO
        ...
        //Enterprises
        //Task1:DYNAMIC PRODUCT PRICE ANALYSIS (ARRAYS)
            ...
            switch(choice){
                case 1:
                   Console.Write("Enter Creator Name: ");
                    ...
                    Console.WriteLine("Enter likes for 4 weeks:");

                    for (int i = 0; i < 4; i++)
                    {
                        Console.Write($"Week {i + 1}: ");
                ...
                case 2:
                    ...
                    var result = app.GetTopPostCounts(EngagementBoard, threshold);

                    if (result.Count == 0){
                        Console.WriteLine("No creator meets the threshold.");
                    }
                    else{
                        foreach (var item in result){
                ...
                case 3:
                    ...
                    Console.WriteLine("Average Likes: " + avg);
                    break;
                case 4:
